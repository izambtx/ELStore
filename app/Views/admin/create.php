                        ...
                        <div class="col-lg-12">
                            <div class="px-5 pt-5 pb-3 my-4">
                                ...
                                <form class="user mt-5" action="<?= url_to('register') ?>" method="post">
                                    ...
                                    <input type="hidden" name="distribusi" id="distribusi" value="1"></input>
                                    ...
                                    <div class="form-group">
                                        <input style="text-transform:uppercase" type="text" class="form-control bg-light form-control-user <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" name="username" placeholder="Username" value="<?= old('username') ?>">
                                    </div>
                                    <div class="form-group row-password">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input style="text-transform:uppercase" type="number" class="form-control bg-light form-control-user <?php if (session('errors.noHP')) : ?>is-invalid<?php endif ?>" name="noHP" placeholder="Phone Number" value="<?= old('noHP') ?>">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control bg-light rounded <?php if (session('errors.alamat')) : ?>is-invalid<?php endif ?>" name="alamat" id="alamat" rows="5" placeholder="Alamat Lengkap"><?= user()->alamat; ?></textarea>
                                    </div>
                                    <button type="submit" class="font-weight-bold btn btn-oren btn-user btn-block">
                                        REGISTER
                                    </button>
                                </form>
                            </div>
