        ...
        <div class="card">
            ...
            <div class="row my-4 mx-3">
                <div class="col-auto mr-auto my-auto">
                    <a href="<?= base_url('/admin/create/products') ?>" type="button" class="icon-btn add-btn">
            ...
            <table class="table table-hover text-gray-900 text-center">
                <thead class="font-weight-bold">
                    <tr>
                        <td scope="col">No</td>
                        <td scope="col">Nama Produk / Jasa Makeup</td>
                ...
                <tbody class="text-gray-900">
                    ...
                    <?php foreach ($produk as $prod) : ?>
                        <tr>
                            ...
                            <td class="align-middle text-capitalize"><?= $prod['nama']; ?></td>
                            <td class="align-middle"><?= $prod['nama_kategori']; ?></td>
                            <td class="align-middle"><?= $prod['created_at']; ?></td>
                            <td class="align-middle"><?= $prod['updated_at']; ?></td>
                            <td class="align-middle">
                                <a href="<?= base_url('/admin/products/' . $prod['id']) ?>" class="btn btn-sm rounded-circle">
                            ...
                            <td class="align-middle">
                                <form action="<?= base_url('/admin/products/' . $prod['id']) ?>" method="post">
                                    <?= csrf_field() ?>
