        ...
        <div class="card">
            ...
            <div class="row my-4 mx-3">
                <div class="col-auto mr-auto my-auto">
                    <a href="<?= base_url('/admin/create/suppliers') ?>" type="button" class="icon-btn add-btn">
                ...
                <tbody class="text-gray-900">
                    ...
                    <?php foreach ($supplier as $s) : ?>
                        <tr>
                            ...
                            <td class="align-middle text-capitalize"><?= $s['nama_supplier']; ?></td>
                            <td class="align-middle"><?= $s['created_at']; ?></td>
                            <td class="align-middle"><?= $s['updated_at']; ?></td>
                            <td class="align-middle">
                                <a href="<?= base_url('/admin/suppliers/' . $s['id']) ?>" class="btn btn-sm rounded-circle">
                            ...
                            <td class="align-middle">
                                <form action="<?= base_url('/admin/suppliers/' . $s['id']) ?>" method="post">
                                    <?= csrf_field() ?>
