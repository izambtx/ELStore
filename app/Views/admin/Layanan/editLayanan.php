                    ...
                    <div class="row-register">
                        ...
                        <div class="col-lg-12">
                            <div class="px-5 pt-5 pb-3 my-4">
                                ...
                                <form class="user" action="<?= site_url('admin/services/' . $layanan->id) ?>" method="post">
                                    <?= csrf_field() ?>

                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user rounded <?php if (session('validation.nama')) : ?>is-invalid<?php endif ?>" name="nama" id="nama" value="<?= $layanan->nama_layanan; ?>" placeholder="Nama Kategori" autofocus>
