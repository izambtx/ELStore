        ...
        <div class="card">
            ...
            <div class="row my-4 mx-3">
                <div class="col-auto mr-auto my-auto">
                    <a href="<?= base_url('/admin/create/categories') ?>" type="button" class="icon-btn add-btn">
                ...
                <tbody class="text-gray-900">
                    ...
                    <?php foreach ($kategori as $k) : ?>
                        <tr>
                            ...
                            <td class="align-middle text-capitalize"><?= $k['nama_kategori']; ?></td>
                            <td class="align-middle"><?= $k['created_at']; ?></td>
                            <td class="align-middle"><?= $k['updated_at']; ?></td>
                            <td class="align-middle">
                                <a href="<?= base_url('/admin/categories/' . $k['id']) ?>" class="btn btn-sm rounded-circle">
                            ...
                            <td class="align-middle">
                                <form action="<?= base_url('/admin/categories/' . $k['id']) ?>" method="post">
                                    <?= csrf_field() ?>
