                    ...
                    <div class="row-register">
                        ...
                        <div class="col-lg-12">
                            <div class="px-5 pt-5 pb-3 my-4">
                                ...
                                <form class="user" action="<?= base_url() ?>/admin/<?= $user->id; ?>" method="post">
                                    <?= csrf_field() ?>
                                    ...
                                    <div class="form-group row-password">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" style="text-transform: uppercase;" class="form-control form-control-user <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" name="username" placeholder="Username" value="<?= $user->username; ?>">
                                    ...
                                    <div class="form-group row-password">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user <?php if (session('errors.noHP')) : ?>is-invalid<?php endif ?>" value="<?= $user->noHP; ?>" name="noHP" placeholder="Nomor Handphone">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control form-control rounded <?php if (session('errors.alamat')) : ?>is-invalid<?php endif ?>" name="alamat" id="alamat" placeholder="Alamat Lengkap" rows="5"><?= $user->alamat; ?></textarea>
                                    </div>
