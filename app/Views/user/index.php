...
<div class="container-fluid mb-5">
    ...
    <div class="row d-flex justify-content-center">
        <div class="custom-card pt-1">
            ...
            <a href="<?= base_url('/change-profile'); ?>" class="text-gray-900 font-weight-bold "><i class="fas fa-user-circle ml-0 mr-2"></i> Change Data</a>
            <a href="<?= base_url('/change-password'); ?>" class="text-gray-900 font-weight-bold mt-1 pl-4"><i class="fas fa-key mr-2"></i> Change Password</a>
        </div>
    </div>
